...
#### The Delta Rule for Perceptrons
...
* 对weight求导，得到delta rule (DELTA Wi,j = -nita * delta(Error, Wi,j))
...
* Rewriting the "body" of the IF
        ...
        Line y = mx + b
        W1X1 + W2X2 = **-** is the "decision boundary"
        Solving for X2
            X2 = (**-** - W1X1) / W2 = (-W1/W2)X1 + **-**
...
1. perceptron
- Learn good derived features (e.g. edge dectors in computer vision)
...
* simple idea, gradient descent, 即偏微分
